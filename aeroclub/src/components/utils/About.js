...
export default function About() {
    return (
        ...
        <section>
        <div className="around card shad">
          {/* <div className="col col-image" data-aos="zoom-in">
          </div> */}
          <div className="col col-text">
            <div className="Aligner-item">
            <div className="">
            <div className="pageTitle titleBold headingc white-headingc" style={{marginBottom:'5px'}} data-aos="fade-down">ABOUT US</div>
            <div className="miniSep" style={{marginBottom:'10px'}} ></div>
              <p className="abttxt" data-aos="zoom-in" style={{padding:'15px'}}> AeroClub MNNIT, established in 2018, is a student body congregating students from various branches of our college.
