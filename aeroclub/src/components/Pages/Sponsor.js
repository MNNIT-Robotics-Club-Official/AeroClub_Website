            ...
            <div className="text-center">
              ...
              <div class="collapse collapsews" id="collapse11">
                <div class="card card-body details" >
                  <p className="just">AeroClub MNNIT, established in 2018, is a student body under the Student Activity Centre (SAC). Since then, it has been the epicenter of the surging ideas in various aerospace field domains, passing through the students, genuinely prepared to do impactful interdisciplinary work. Here, we work across all the aerospace sector domains ranging from RC planes to design, from aerodynamic analysis to autonomous drones, from biomimicking to astronomy, and various others
                  (<Link to={{ pathname: '/', state: { scrollToRT: true } }}>Link</Link>), catalyzed by abstract classes, open discussions, and projects.
                  Speaking of achievements, our club has won accolades in many national level competitions (Link) and completed a diverse range of projects (<Link to='/projects/featured'>Featured</Link>, <Link to='/projects'>Others</Link>) and, most importantly, emphasized innovation with state-of-the-art projects like drone automation, RC planes, etc.
                  We are proud to say that our club is the birthplace of a fully functional startup, <a href="https://tsaw.tech/" target="_blank">TSAW</a>. Also, our club's prosperity resulted in an offshoot, <a href={process.env.REACT_APP_ASTROWING} target='_blank'>
                      Astronomy</a> itself, which focuses entirely upon the field of astronomy and theoretical sciences. The club, in these years, has achieved enormous growth, and in the future, we aim to surpass our past achievements.
</p>
