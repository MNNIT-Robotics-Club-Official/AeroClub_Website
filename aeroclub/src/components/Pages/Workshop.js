      ...
      <section className="section1 pagese ">
        <div className="overlaye">
          <div className="containere ">
            <h1 className="titlee">
              <div className="pageTitlee titleBolde">Jigyasa</div>
            </h1>
      ...
      >
            ...
            <div className="text">
              ...
              >
                <div style={{ padding: "10px" }}>
                  ...
                  >
                    <i>
                      Avishkar is MNNIT's annual techno-management festival and
                      is held either in September or October. Equipped with many
                      technical and managerial events, Avishkar is an excellent
                      platform for students to hone their skills, create
                      outstanding projects, expand their networks, and build a
                      superb CV.
                    </i>
                  </p>
                </div>
        ...
        <Container id="workshop" onSelect={(e) => SetWorkshops(e)}>
          ...
          {workshops.map((singleNews) => (
            <div
              className="card mb-5 mx-4 workshop_card shadow"
              data-aos="zoom-in-up"
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <span className="value">{singleNews.target}</span>
                    <br />
                    ...
                    <span
                      className="value ql-editor"
                      dangerouslySetInnerHTML={{
                        __html: singleNews.prerequisites,
                      }}
                    ></span>
                    <div
                      className="value mt-3 ql-editor"
                      dangerouslySetInnerHTML={{ __html: singleNews.about }}
                    ></div>
