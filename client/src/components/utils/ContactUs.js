    ...
    return (
        <div className="contact-us">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center">
                <div className="contact-map col-sm-12 col-md-10 col-lg-10">
                ...
                <div className="contact-us-body d-flex flex-wrap justify-content-center align-items-center col-sm-12 col-md-12 col-lg-10">
                    <div className="contact-logo align-self-center d-flex flex-column justify-content-center align-items-center col-sm-12 col-md-4 col-lg-6">
                        <img src={`${baseURL}/images/utils/mnnit.png`} alt="mnnit" srcset="" />
                        <div className="col-sm-12 col-md-12 col-lg-8">
                            <h6>Motilal Nehru National Institute of Technology, Allahabad</h6>
                        </div>
                    </div>
                    <div className="contact-information col-sm-12 col-md-5 col-lg-5">
                        ...
                        <div className="contact-email d-flex justify-content-start">
