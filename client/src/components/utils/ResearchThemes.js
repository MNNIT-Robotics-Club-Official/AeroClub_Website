            ...
            <div className="jumbotron">
                        ...
                        <div class="card text-center" style={{ marginBottom: '1.5rem', width: 'auto' }} >
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <p>Multirotors</p>
                                    <p>Space Vehicles </p>
                                    <a href="#" class="btn btn-dark">Astronomy</a>
                ...
                <div className="i-am-centered">
                    ...
                    <div className="col-sm-10" data-aos="fade-up">
                        <div class="card text-center" style={{ marginBottom: '0.5rem', width: 'auto' }} >
                            <div class="card-header" style={{ fontSize: '1.5rem', background: 'rgb(56, 55, 55)', color: 'white', border: '3px solid white' }}>
                            Technologies
                        ...
                        <div className="col-sm-5" data-aos="zoom-in-down" data-aos-duration="1500">
                            <div className="card" style={{ marginBottom: '1rem'}}>
                                <div className="card-body" style={{background:'rgb(204, 67, 67)' }}>
                                    ...
                                    Deep Learning<br />
                                    Object Detection, Tracking and Avoidance<br />
                                    Computer Vision<br />
                                    Sensor Fusion<br /></p>
                            ...
                            <div className="card" style={{ marginBottom: '1rem'}}>
                                <div className="card-body" style={{background:'rgb(204, 67, 67)'}}>
                                    ...
                                    <p className="card-text" style={{color:'white'}}>Computer Aided Design<br />
                                        ...
                                        Design and Manufacture of RC Aircrafts and Multirotors<br />
                                        3D Printing<br />
                                        Materials<br /><br /></p>
                        ...
                        <div className="col-sm-5" data-aos="zoom-in-down" data-aos-duration="1500">
                            <div className="card" style={{ marginBottom: '1rem'}}>
                                <div className="card-body" style={{background:'rgb(204, 67, 67)'}}>
                                    ...
                                    Different Actuators and their Control<br />
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card" style={{ marginBottom: '1rem'}}>
                                <div className="card-body" style={{background:'rgb(204, 67, 67)'}}>
                                    ...
                                    <p className="card-text" style={{color:'white'}}>CFD Simulations<br />
                                        Aerofoil Analysis<br />
                                        Lift and Drag Studies<br />
