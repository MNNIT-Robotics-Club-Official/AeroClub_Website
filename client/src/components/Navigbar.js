...
<<<<<<< HEAD
      {/* <Navbar className="top-bottom" expand="lg"> */}
        <Navbar.Brand href="#home" className="title"><span><img src={logo} style={{ height:50, marginRight:5, marginLeft:8}} />AERO CLUB MNNIT</span></Navbar.Brand>
=======
        {/* <Navbar className="top-bottom" expand="lg"> */}
...
>>>>>>> 06e8f9399b897f1a76ca6486e30372630cbee6a2
